...
public int getCntPage() {
 ...
 public EstatePageVO(int total, int nowPage, int cntPerPage) {
 ...
 public EstatePageVO(int total, int nowPage, int cntPerPage,String searchType,String searchValue) {
  this.searchType=searchType;
  this.searchValue=searchValue;
  this.nowPage=nowPage;
  this.cntPerPage=cntPerPage;
